import ImagePreview from "@/components/deprecated/Thread/ImagePreview";
...
const Gallery: React.FC<Props> = ({ images }) => {
  ...
  const SECONDARY_COL_HEIGHT =
    PRIMARY_COL_HEIGHT / 2 - parseFloat(theme.spacing.md) / 2;
  const TERTIARY_COL_HEIGHT =
    PRIMARY_COL_HEIGHT / 3.2 - parseFloat(theme.spacing.md) / 3.2;
