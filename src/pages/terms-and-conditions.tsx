			...
			>
				<Typography>
					...
					<p>
						...
						regulations for the use of UMT Fellow&apos;s Website,
						located at{" "}
					...
					<p>
						...
						terms and conditions. Do not continue to use UMT Fellow
					...
					<p>
						We employ the use of cookies. By accessing UMT Fellow,
						you agreed to use cookies in agreement with the UMT
						Fellow&apos;s Privacy Policy.{" "}
					</p>

					<p>
						Most interactive websites use cookies to let us retrieve
						the user&apos;s details for each visit. Cookies are used
						by our website to enable the functionality of certain
					...
					<p>
						Unless otherwise stated, UMT Fellow and/or its licensors
						own the intellectual property rights for all material on
						UMT Fellow. All intellectual property rights are
						reserved. You may access this from UMT Fellow for your
					...
					<p>You must not:</p>
					<ul>
						<li>Republish material from UMT Fellow</li>
						<li>
							Sell, rent or sub-license material from UMT Fellow
						</li>
						<li>
							Reproduce, duplicate or copy material from UMT
							Fellow
						</li>
						<li>Redistribute content from UMT Fellow</li>
					</ul>
					...
					<p>
						UMT Fellow reserves the right to monitor all Comments
					...
					<p>
						You hereby grant UMT Fellow a non-exclusive license to
					...
					<p>
						...
						(c) fits within the context of the linking party&apos;s
						site.
					</p>
					...
					<p>
						...
						UMT Fellow; and (d) the link is in the context of
					...
					<p>
						...
						you must inform us by sending an e-mail to UMT Fellow.
					...
					<p>
						No use of UMT Fellow&apos;s logo or other artwork will
					...
					<p>
						...
						and conditions and it&apos;s linking policy at any time.
						By continuously linking to our Website, you agree to be
